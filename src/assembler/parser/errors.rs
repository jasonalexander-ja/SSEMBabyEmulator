...
//! during parsing, all error types implement [ParseError][crate::assembler::parser::errors::ParseError].
//! 
//! The main type in this module is [LineParseError][crate::assembler::parser::errors::LineParseError]
